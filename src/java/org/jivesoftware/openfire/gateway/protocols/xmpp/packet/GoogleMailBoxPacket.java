    ...
    public static class Provider implements IQProvider {
        ...
        public IQ parseIQ(XmlPullParser parser) throws Exception {
            ...
            try {
                ...
                //Log.log(Level.ALL, "XMPP: IO exception while parsing mailbox packet:", ex);
            }
            catch (XmlPullParserException ex) {
                //Log.log(Level.ALL, "XMPP: XML pull exception while parsing mailbox packet:", ex);
            }
            catch (Exception ex) {
                //Log.log(Level.ALL, "XMPP: Unknown exception while parsing mailbox packet:", ex);
                String a = "32";
            }
